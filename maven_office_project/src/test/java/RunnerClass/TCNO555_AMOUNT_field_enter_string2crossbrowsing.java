...
public class TCNO555_AMOUNT_field_enter_string2crossbrowsing {
	...
	public void launchbrwser(String browser) throws InterruptedException {
		...
		Reporter.log("ChromeBrowsing testing completed",true);
			...
			driver=BaseClass.firefox("http://demo-rt-cb-qa-alb-1696234791.us-east-1.elb.amazonaws.com/#/account/email-confirmation?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6InByYXZpbmxAbnUxMC5jbyIsImlhdCI6MTY2NTAyNTU4NiwiZXhwIjoxNjY1MDQ3MTg2fQ.7wbo30nt99mT4GJMxKC0RYgXhR6d1bAjvsVNjuaYHRA");
			driver.manage().timeouts().implicitlyWait(Duration.ofMillis(6000));
